"""Kernel subsystem — schema registry, record identity, command envelope, transaction preview, state delta, event ledger, RNG interface, table/oracle, validation pipeline."""
