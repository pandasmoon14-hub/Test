...
CLOSURE_HEAD="739a5aa4782173986b55020f13e88e832c527877"
...
def test_downstream_remains_unauthorized():
 m=load_at(CLOSURE_HEAD,MAN); by={x["workstream_id"]:x for x in m["workstreams"]}
...
def test_cross_recording_and_scope():
 ...
 changed=set(git("diff","--name-only",f"{MERGE}...{CLOSURE_HEAD}").splitlines()); changed.discard("")
