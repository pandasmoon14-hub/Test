# Executable validation for PR2-CONC post-merge closure.
...
def test_conc_is_terminal_merged_with_exact_acceptance_evidence():
    manifest = load(MAN)
...
def test_closure_does_not_change_conc_contract():
