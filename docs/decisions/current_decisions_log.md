...
- **Sources and claims:** Exactly five external raw-source identities are registered through the retained compact intake packet; exactly thirty-one normalized claims cover CF-01–CF-13. The raw reports remain outside the repository.
- **Primary routing counts:** 3 already governed by R1; 5 partial R2 qualifications; 7 new R2 candidates; 1 R3 obligation; 3 R4 obligations; 1 R5 obligation; 3 evaluations; 2 later GM-adapter inputs; 3 deferred frontiers; and 3 rejected-overengineering claims.
...
## 2026-09-14 decision — PR2-CONC post-merge closure

- **Decision ID:** `PR2-CONC-POST-MERGE-CLOSURE-001`
- **Workstream:** `PR2-CONC`
- **Accepted pull request:** `#401`
- **Accepted branch head:** `684740e41ab3ae10759d6b999c23e8cc6ff9c470`
- **Accepted merge commit:** `5752de38f432c59f9e603ffd1ef38384e621a407`
- **Accepted merge tree:** `f5cdf3282132537088088ee6aa0592a82354b063`
- **Authority reference:** `owner_directive_2026-09-14_pr2_conc_post_merge_closure`
- **Authority effect:** `runtime_concurrency_governance_post_merge_lifecycle_reconciliation_only`

PR2-CONC is terminal `merged`. This decision records accepted GitHub lifecycle
state only and does not alter the substantive deterministic concurrency/scheduling contract.

No successor is activated by the PR2-CONC closure. PR2-EVENT remains blocked
and unauthorized, as do PR2-PERSIST, PR2-FID, and PR2-BP.
...
## 2026-09-15 decision — PR2-PERSIST post-merge closure

- **Decision ID:** `PR2-PERSIST-POST-MERGE-CLOSURE-001`
- **Workstream:** `PR2-PERSIST`
- **Accepted pull request:** `#405`
- **Accepted branch head:** `814476c63d5ee65701f1abfff19db5b347c1dd05`
- **Accepted merge commit:** `e53e64f92fe2639d68c96bfa70825c6f6ec39f03`
- **Accepted merge tree:** `9171db95438dfc75460ed7c340f3be5d84813825`
- **Accepted GitHub Actions:** `CI #209:success`
- **Authority reference:** `owner_directive_2026-09-15_pr2_persist_post_merge_closure`
- **Authority effect:** `runtime_persistence_governance_post_merge_lifecycle_reconciliation_only`

PR2-PERSIST is terminal `merged`.

This decision records accepted GitHub lifecycle state only and does not
alter the substantive persistence, snapshot, replay, recovery, or
reconstruction contract.

No successor is activated by the PR2-PERSIST closure. PR2-FID and PR2-BP
remain blocked and unauthorized. PR2-TEST also remains blocked.

R3 remains `ready_pending_authorization` against the exact 34-record
conformance target with execution disabled. This closure does not assert
that R3 has already executed or completed.
...
## 2026-09-16 decision — PR2-FID post-merge closure

- **Decision ID:** `PR2-FID-POST-MERGE-CLOSURE-001`
- **Workstream:** `PR2-FID`
- **Accepted pull request:** `#407`
- **Accepted branch head:** `6a3fd4de79fb421fc03352b311c1168faa71255a`
- **Accepted merge commit:** `c077abf5a90e896ef535d4956c49803cbf8163b6`
- **Accepted merge tree:** `766d61cb47101f15eefb14db88607f3473c006e3`
- **Accepted GitHub Actions:** `CI #213:success`
- **Authority reference:** `owner_directive_2026-09-16_pr2_fid_post_merge_closure`
- **Authority effect:** `runtime_fidelity_governance_post_merge_lifecycle_reconciliation_only`

PR2-FID is terminal `merged`.

This decision records accepted GitHub lifecycle state only and does not
modify the substantive PR2-FID relevance, fidelity, aggregation,
reconstitution, or materialization-boundary contract.
